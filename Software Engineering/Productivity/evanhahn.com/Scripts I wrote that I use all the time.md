...
* Command `url "${some url}"` that parses a URL into its parts
  * [Script location](https://codeberg.org/EvanHahn/dotfiles/src/commit/843b9ee13d949d346a4a73ccee2a99351aed285b/home/bin/bin/url)
  * Uses `python3`'s `urllib.parse`
...
* Print current date in ISO format
  * [Wraps `date` command](https://codeberg.org/EvanHahn/dotfiles/src/commit/843b9ee13d949d346a4a73ccee2a99351aed285b/home/bin/bin/hoy) 
* [`rn` (right now) command](https://codeberg.org/EvanHahn/dotfiles/src/commit/843b9ee13d949d346a4a73ccee2a99351aed285b/home/bin/bin/rn) that prints current date + time with calendar view
...
* `notify` to send operating system notifications
  * [This command adds additional syntax](https://codeberg.org/EvanHahn/dotfiles/src/commit/843b9ee13d949d346a4a73ccee2a99351aed285b/home/bin/bin/notify) that adds the current application
